...
metaDescription: Подробное объяснение подхода горизонтальные слайсы horizontal-slices - как организовать структуру проекта по фичам вместо слоев и избежать типичных проблем...
author: Олег Марков

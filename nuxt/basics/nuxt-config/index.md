...
metaDescription: Подробная инструкция по настройке config в Nuxt - разбор nuxt config для разных версий, примеры использования настройки роутера и модулей, работа с...
author: Олег Марков

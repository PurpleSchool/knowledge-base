...
// Здесь мы импортируем провайдер PaperProvider и кнопку Button,
// и используем их в компоненте App.
...
| Библиотека               | Основной стиль       | Поддержка тем  | Кастомизация  | Количество компонентов | Особенности         |
|--------------------------|---------------------|----------------|--------------|-----------------------|---------------------|
| React Native Paper       | Material Design     | Да             | Средняя      | Много                 | Отличная совместимость с Expo, тёмная тема |
| NativeBase               | Универсальный       | Да             | Гибкая       | Очень много           | Готовые шаблоны форм, интеграция с TypeScript |
| React Native Elements    | Минимализм          | Частично       | Высокая      | Средне                | Очень простая интеграция, платформа-независимость |
| UI Kitten                | Eva Design System   | Да             | Гибкая       | Много                 | Лучшая поддержка кастомных тем |
| Material UI (RN)         | Material Design     | Да             | Средняя      | Не очень много        | Строгий google-style, акцент на Android |

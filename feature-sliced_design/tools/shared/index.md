...
metaDescription: Подробное руководство по shared конфигурации shared-config - как проектировать общие настройки для микросервисов избегать дублирования и централизовать...
author: Олег Марков

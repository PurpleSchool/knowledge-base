...
metaDescription: Разбираем как устроена регистрация компонентов в приложениях на примере DI контейнера - какие подходы есть как описывать зависимости и как управлять...
author: Олег Марков

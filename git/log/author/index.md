...
metaDescription: Узнайте как использовать параметр git log --author для фильтрации истории коммитов по конкретным авторам и шаблонам имен - изучите синтаксис и тонкости...
author: Олег Марков

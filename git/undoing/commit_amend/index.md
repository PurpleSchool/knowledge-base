...
metaDescription: Подробное руководство по использованию git commit --amend - как изменить сообщение последнего коммита добавить забытые файлы или переписать историю...
author: Олег Марков

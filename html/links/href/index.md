...
metaDescription: Разберитесь как работает атрибут href в HTML - какие значения он принимает - чем отличаются абсолютные и относительные ссылки - как использовать якоря -...
author: Олег Марков

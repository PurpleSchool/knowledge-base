...
Псевдокласс `:root` позволяет стилизовать корневой элемент HTML и SVG, что может быть полезным для определения глобальных стилей и переменных, которые используются на всем сайте. Но для эффективного использования этого псевдокласса необходимо понимать, как работают глобальные стили, как применять переменные CSS и как учитывать особенности отображения в разных браузерах. Если вы хотите детальнее изучить CSS и научиться создавать сложные и красивые веб-страницы, — приходите на наш большой курс [HTML и CSS](https://purpleschool.ru/course/html-css?utm_source=knowledgebase&utm_medium=text&utm_campaign=psevdoklass-root-v-css-polnoe-rukovodstvo-s-primerami). На курсе 212 уроков и 19 упражнений, AI-тренажеры для безлимитной практики с кодом и задачами 24/7, решение задач с живым ревью наставника, еженедельные встречи с менторами.

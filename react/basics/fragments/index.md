...
author: Олег Марков
title: "Fragment в React: группировка элементов без лишних узлов DOM"
preview: "Разбираем React Fragment — синтаксис, краткая запись <>, использование с key, отличия от div и практические примеры для чистой структуры DOM."
---

...
metaDescription: Узнайте как работать с пользовательскими данными в HTML через data-* атрибуты - разберитесь с синтаксисом доступом из JavaScript и практическими примерами...
author: Олег Марков
